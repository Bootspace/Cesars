...
function App() {
  ...
  return (
    <main className="h-screen min-w-[1100px] overflow-npne grid grid-rows-[40px_2fr_3fr_3fr_2fr_3fr_3fr_4fr_3fr_2fr]">
      <Top />
      <Nav />
      <div className="grid grid-cols-[.3fr_1fr] min-w-[1100px]">
        <section className="px-20 py-10 min-w-48 max-[375px]:pl-5 max-[375px]:mr-5">
          <ul className="flex flex-col gap-3">
            <li><a href="/" className="hover:underline decoration-solid">Woman&apos;s Fashion</a></li>
      ...
      <section className="py-10 px-20 min-w-[1100px]">
        ...
        <section className="flex gap-20 mt-10 justify-between">
          <Card offer={false} />  
          <Card offer={false} />
          <Card offer={false} />
          <Card offer={false} />
